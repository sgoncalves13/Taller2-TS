...
export const series = [
    ...
    new Serie (3, "Game of Thrones","HBO", 7, "Game of Thrones is an American television series based on the popular fantasy book series 'A Song of Ice and Fire' by George R.R. Martin. The series is set in the fictional medieval world of Westeros, where noble families fight for control of the Iron Throne, the seat of the King of the Seven Kingdoms. The show features an ensemble cast of characters, including noble families such as the Starks, Lannisters, and Targaryens, as well as characters from the Night's Watch and the Free Folk. Game of Thrones has been praised for its complex characters, political intrigue, and epic battle scenes, and has won numerous awards, including Primetime Emmy Awards for Outstanding Drama Series. The show has become a cultural phenomenon and is widely regarded as one of the greatest television series of all time", "https://www.hbo.com/game-of-thrones",
